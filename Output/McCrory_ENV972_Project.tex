...
\hypersetup{
  pdftitle={Long-term trends in cadmium and lead concentrations in Mytilus edulis from coastal European monitoring sites},
...
\begin{figure}
\includegraphics[width=0.92\linewidth]{C:/Users/senam/Box Sync/My Documents/MEM classes/Duke Spring 2020/DataAnalytics/ENV872_FinalProject/Output/StudyRegionMap2} \caption{Monitoring locations of ICES DOME samples for cadmium and lead concentrations in *Mytilus edulis* from 1990 to 2018}\label{fig:unnamed-chunk-1}
\end{figure}
